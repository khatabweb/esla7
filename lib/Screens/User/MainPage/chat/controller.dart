...
class ChatController {
  ...
  Future<ChatModel> getMessage(int? id) async {
    ...
    var response =
    await _netWork.postData(url: 'api/getConversationById', formData: _formData,);
  ...
  Future<void> sendMessage({XFile? file,int? senderId,String? message,int? conversationId,int? receiverId})async{
    SharedPreferences _prefs = await SharedPreferences.getInstance();
    var id;
    ...
    FormData _formData = FormData.fromMap({
     ...
     var response = await _netWork.postData(url: 'api/addMassage',formData: _formData,);
  ...
  Future<int> startChat(int? docId)async{
    ...
    final response = await _netWork.postData(url: 'api/addConversation',formData: formData,);
