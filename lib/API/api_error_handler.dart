...
class ResponseMessage {
  static const String EXCEPTION = ApiErrors.exception; // success with data
...
extension DataSourceExtension on DataSource {
  ApiErrorModel getFailure() {
    switch (this) {
      ...
      case DataSource.EXCEPTION:
        return ApiErrorModel(
            code: ResponseCode.NO_CONTENT, message: ResponseMessage.EXCEPTION);
    }
  }
}
